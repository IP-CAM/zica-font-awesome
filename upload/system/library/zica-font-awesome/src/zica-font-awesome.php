<?php
/**
 * Zica Font Awesome Library
 *
 *
 * @author   Jano Sousa
 * @link     https://github.com/sincromaster/zica-font-awesome
 * @link     https://sincromaster.com.br
 * @version  1.0.0
 *
 * 
 */
...
/**
 * @package Original A PHP library for Font Awesome
 * @link     https://github.com/awps/font-awesome-php
  */


class Zica_Font_Awesome {
	...
	private function Get_css() {
		...
		$this->css = DIR_APPLICATION.'view/javascript/font-awesome/css/font-awesome.min.css';
		// Get the list of available icons from the Font Awesome CSS.
		//$this->readCss( $this->css );
	 ...
	 */
	/*private function setup_icon_array( $css, $fa_css_prefix = 'fa' ) {
